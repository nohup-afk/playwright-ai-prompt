...
// Generated by the playwright-ai agent — goal: login to leadmanager and search project 'hotel'
...
test("login to leadmanager and search project 'hotel'", async ({ page, ai }) => {
